...
- [x] **Phase 10: TV Match Test Coverage** - Unit tests for scoring/threshold, integration tests for auto-match pipeline, tests for review UI with new status model (completed 2026-03-07)
