...
func (h *Handler) Router() http.Handler {
	...
	mux.HandleFunc("/display/modes", h.displayModes)
	mux.HandleFunc("/display/mode", h.displayModeApply)
	mux.HandleFunc("/display/mode/confirm", h.displayModeConfirm)
	...
	mux.HandleFunc("/music/playlists", h.musicPlaylists)
	mux.HandleFunc("/music/playlist", h.musicPlaylistDetail)
	mux.HandleFunc("/music/playlist/create", h.musicPlaylistCreate)
	mux.HandleFunc("/music/playlist/add-track", h.musicPlaylistAddTrack)
	mux.HandleFunc("/music/playlist/remove-track", h.musicPlaylistRemoveTrack)
	mux.HandleFunc("/music/playlist/move", h.musicPlaylistMove)
	mux.HandleFunc("/music/playlist/rename", h.musicPlaylistRename)
	mux.HandleFunc("/music/playlist/delete", h.musicPlaylistDelete)
	...
	mux.HandleFunc("/tv/mark-watched", h.tvMarkWatched)
