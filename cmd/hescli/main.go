...
_hescli() {
  ...
  local cfgkeys="tmdb_api_key fanarttv_api_key audiodb_api_key lastfm_api_key opensubtitles_api_key opensubtitles_user_agent integrity_autorepair external_metadata_enabled watch_enabled job_resume_enabled lyrics_enabled update_check_enabled default_audio_lang default_subtitle_lang subtitles_default_on subtitle_size subtitle_bg subtitle_position media_root"
